<?php 
$koneksi = mysqli_connect('localhost', 'root', '', 'pegawaibasdatii_if-7_kepegawaian');
...
<tr>
    ...
    <td>
        ...
        <div class="modal fade" id="view_image" tabindex="-1" role="dialog" aria-labelledby="view_image"
            aria-hidden="true">
    ...
    <td><button class="btn btn-danger" data-toggle="modal" data-target="#hapus_ket<?=$pro['id'];?>">hapus</button>
        <div class="modal fade" id="hapus_ket<?=$pro['id'];?>" tabindex="-1" role="dialog"
